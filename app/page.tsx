      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="bg-slate-900 text-white rounded-2xl shadow-lg p-8">
          ...
          <p className="mt-2 text-slate-200">
            A web-based dashboard for monitoring the time-series behavior of MSTR mNAV
            using Bitcoin price and MSTR stock price data.
          </p>
        ...
        {!loading && !error && latest && (
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
            ...
            <div className="bg-white rounded-2xl shadow p-5">
              ...
              <p className="text-2xl font-bold text-slate-900 mt-1">
                $
                {latest.mstrClose.toLocaleString(undefined, {
                  maximumFractionDigits: 2,
                })}
              </p>
            </div>
